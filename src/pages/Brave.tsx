...
import motionlogo  from "../icons/vapora1.svg"
...
import motionTechImg from "../images/vapor.webp";
import bravesideimg from "../icons/brave1.svg"; // FIT vertical writing image asset
...
const SPEC_BADGES = [
  { icon: windproofIcon, label: "Waterproofness" },
  { icon: bulkicon, label: "Total wind protection" },
  { icon: strengthicon, label: "High breathability" },
];
...
With the BRAVE fabric line, ZeroWind redefines the concept of windproof protective shell.
        ...
        <div className="pl-5 max-w-4xl mx-auto space-y-4 text-left text-[#f5f5f5] text-xl md:text-2xl leading-relaxed font-light tracking-wide">
          ...
          >
High wind protection combined with maximum lightness
 thanks to the innovative single-layer fabric 
 construction. Ultralight fabrics perfect for 
 making garments with excellent technical 
characteristics, durable and extremely easy to carry.             </motion.p>
