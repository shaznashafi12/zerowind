...
import motionTechImg from "../images/brave.webp";
import powersideimg from "../icons/power1.svg"; // FIT vertical writing image asset

import teampest from "../images/teampest.webp";
...
export default function Motion() {
  ...
  const showpowerLabel = pastHero && !reachedMotionSection;
      ...
      <AnimatePresence>
        {showpowerLabel && (
          <motion.div
            ...
            className="fixed -left-[110px] top-1/2 -translate-y-1/2 z-40 hidden lg:block pointer-events-none"
          >
            <img
              src={powersideimg}
              alt="POWER"
...
Wind protection is the goal behind
 ZeroWind's POWER fabric line, to which we have 
 combined 
excellent breathability and comfortable fit.</motion.p>
        ...
        <div className="pl-5 max-w-4xl mx-auto space-y-4 text-left text-[#f5f5f5] text-xl md:text-2xl leading-relaxed font-light tracking-wide">
          ...
          >
            3-layer fabrics with performances guaranteed by a
             proven, totally PFAS-free windproof treatment 
             enclosed between two fabrics to create reliable, 
            high-performance garments in a wide range of weights </motion.p>
