...
import img3 from "../images/bergamo.webp";
    ...
    <main className="w-full bg-[#272727] text-white font-sans overflow-hidden">
      ...
      <section className="relative z-20 max-w-5xl pt-20 mx-auto px-4 sm:px-6 -mt-12 md:-mt-24 pb-20">
        ...
        >
          ...
          >
            <motion.p variants={fadeInUp}>Fabric developed for mid season.</motion.p>
            <motion.p variants={fadeInUp}>Windproof, breathable, water-resistant and very elastic.</motion.p>
            <motion.p variants={fadeInUp}>For temperatures from 9° to 15°C</motion.p>
          </motion.div>
