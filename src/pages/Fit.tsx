...
import motionlogo  from "../icons/motion1.svg"
...
import motionTechImg from "../images/motion.webp";
import fitSideImg from "../icons/fit1.svg"; // FIT vertical writing image asset

import arsenalJacketImg from "../images/arsenal.webp";
import bergamoJacketImg from "../images/bergamo.webp";
import grandPrixJacketImg from "../images/grandprix.webp";
...
export default function Fit() {
  ...
  const showFitLabel = pastHero && !reachedMotionSection;
  ...
  return (
<div className="relative -pt-20 w-full bg-[#272727] text-white font-sans overflow-x-hidden selection:bg-[#d4ff00] selection:text-black">
      ...
      <AnimatePresence>
        {showFitLabel && (
          <motion.div
            ...
            className="fixed -left-[20px] top-1/2 -translate-y-1/2 z-40 hidden lg:block pointer-events-none"
          >
            <img
              src={fitSideImg}
              alt="FIT"
...
className="h-[70px] sm:h-[130px] md:h-[120px] w-auto object-contain"/>
      ...
      {/* ================= INTRO & FEATURES SECTION ================= */}
       ...
       >
        ...
        <div className="max-w-4xl mx-auto space-y-4 text-left text-[#f5f5f5] text-xl md:text-2xl leading-relaxed font-light tracking-wide">
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            hydrophilic membrane create garments that combine high
            performance with extraordinary comfort that enhances the
            technicality of the material.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            the passage of moisture to the outside through osmosis, and
