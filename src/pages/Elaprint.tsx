...
import img1 from "../images/elaprint.webp";
// --- CUSTOM SPEC ICONS ---
...
export default function Elaprint() {
  // Animation Variants
    ...
    <main className="w-full bg-[#272727] text-white font-sans overflow-hidden">
      ...
      <section className="relative z-20 max-w-5xl pt-20 mx-auto px-4 sm:px-6 -mt-12 md:-mt-24 pb-20">
        ...
        >
          ...
          >
            <motion.p variants={fadeInUp}>Winter will no longer stand in the way of your outings with Elaprint ZWR.</motion.p>
            <motion.p variants={fadeInUp}>Windproof, breathable, rainproof, insulating and elastic.</motion.p>
            <motion.p variants={fadeInUp}>For temperatures from -1° to 8°C</motion.p>
          </motion.div>
