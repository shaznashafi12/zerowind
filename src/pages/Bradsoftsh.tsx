...
import img1 from "../images/bradsoftsh.webp";
  ...
  return (
    <main className="w-full bg-[#272727] text-white font-sans overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex flex-col items-center justify-center pt-16 pb-12 px-4 overflow-hidden">
        {/* Background Big Outline Text - Matched to Image Reference */}
        <motion.div
        ...
        >
          <h1 className="flex flex-col items-center text-center font-black uppercase tracking-[0.02em] leading-[0.82] outline-text">
            <span className="text-[17vw] md:text-[15vw]">BRAD</span>
            <span className="text-[16vw] md:text-[14vw]">SOFTSHELL</span>
          </h1>
        </motion.div>
      ...
      <section className="relative z-20 max-w-5xl pt-20 mx-auto px-4 sm:px-6 -mt-12 md:-mt-24 pb-20">
        ...
        >
          ...
          >
            <motion.p variants={fadeInUp}>Winter softshell with highly breathable membrane and total wind protection.</motion.p>
            <motion.p variants={fadeInUp}>High abrasion resistance.</motion.p>
            <motion.p variants={fadeInUp}>Very stretchy, perfect for slim fit garments.</motion.p>
            <motion.p variants={fadeInUp}>Environmentally friendly water repellent treatment (PFAS free).</motion.p>
          </motion.div>

          {/* Subtext */}
          <p className="text-xs text-neutral-500 mb-12">
            Photo: Heavy Primapelle winter jacket by Pissei (
            <a
              href="https://pissei.com"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto">
            ...
            >
              ...
              <span className="text-2xl sm:text-3xl font-black italic tracking-wider group-hover:text-[#d4ff00] transition-colors">MOTION</span>
            </motion.div>
