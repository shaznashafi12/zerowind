...
import fitIcon from "../icons/excelfit.svg";
    ...
    <main className="w-full bg-[#272727] text-white font-sans overflow-hidden">
      ...
      <section className="relative z-20 max-w-5xl pt-20 mx-auto px-4 sm:px-6 -mt-12 md:-mt-24 pb-20">
        ...
        >
          ...
          >
            <motion.p variants={fadeInUp}>Double-sided fabric for cold season.</motion.p>
            <motion.p variants={fadeInUp}>Windproof, breathable, elastic, insulating.</motion.p>
            <motion.p variants={fadeInUp}>For temperatures from 8° to 15°C</motion.p>
          </motion.div>

          {/* Subtext */}
          <p className="text-xs text-neutral-500 mb-12">
            Photo: Pro Team jacket by GSPORT (
            <a
              href="https://gsportapparel.com/"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-12">
            ...
            />
            <FeatureBadge
              icon={<img src={fitIcon} alt="Excellent fit" className="w-9 h-9 object-contain spec-icon-tint" />}
              label="Excellent fit"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto">
            ...
            >
              ...
              <span className="text-2xl sm:text-3xl font-black italic tracking-wider group-hover:text-[#d4ff00] transition-colors">POWER</span>
            </motion.div>
